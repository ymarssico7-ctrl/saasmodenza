        ...
        >
          {produtosAtivos.length === 0 ? (
            <div className="flex flex-col items-center gap-2 py-10 text-center text-muted-foreground">
              ...
              <p className="text-xs">
                Ative produtos no menu <strong>Vitrine → Meus Produtos</strong> para compartilhar links diretamente.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="h-14 w-11 rounded-lg bg-secondary/60 flex items-center justify-center overflow-hidden">
                      {cfg?.vitrineFotos?.[0] ? (
                        ...
                        <span className="text-[9px] text-muted-foreground text-center px-1">{p.name?.slice(0, 10)}</span>
                      )}
                    </div>
