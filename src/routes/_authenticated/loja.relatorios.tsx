    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <div key={kpi.label} className="surface-card flex items-start justify-between gap-3 p-5">
            <div>
                    ...
                    <PieChart>
                      ...
                      >
                        {vendasPorCategoria.map((_, i) => (
                          <Cell key={i} fill={CORES_CHART[i % CORES_CHART.length]} />
                        ))}
                      </Pie>
                      <Tooltip
                        formatter={(v) => brl(Number(v))}
