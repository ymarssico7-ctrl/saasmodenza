...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Vestui — Gestão financeira & Loja online para moda" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Vestui — Gestão financeira & Loja online para moda" },
      {
      ...
      <section className="mx-auto grid w-full max-w-6xl items-center gap-14 px-5 pb-16 pt-14 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:pb-28 lg:pt-24">
        <div>
          ...
          <p className="mt-6 max-w-lg text-[15px] leading-relaxed text-muted-foreground sm:text-base">
            O Vestui mostra quanto você realmente lucra em cada peça, organiza o caixa, separa seu
